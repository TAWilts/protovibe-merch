...
describe('LandingView registration', () => {
  ...
  it('keeps the top anchor on the page frame and exposes the main-content target', () => {
    ...
    expect(wrapper.findAll('.faq-list article')).toHaveLength(6)
    expect(wrapper.get('.faq-list').text()).toContain('landing.faq.purpose.question')
    expect(wrapper.get('.faq-list').text()).toContain('landing.faq.deletion.question')
    expect(wrapper.get('.faq-list').text()).toContain('landing.faq.costs.question')
    expect(wrapper.get('.faq-list').text()).toContain('landing.faq.shopApi.question')
    expect(wrapper.get('.faq-list').text()).toContain('landing.faq.sandbox.question')
    expect(wrapper.get('.faq-list').text()).toContain('landing.faq.offline.question')
